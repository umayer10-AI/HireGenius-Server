...
export declare function createNotification(input: {
    ...
    link?: string;
}): Promise<import("../interfaces/models.js").NotificationDocument>;
export declare function getUserNotifications(userId: ObjectId, page: number, limit: number): Promise<{
    data: import("../interfaces/models.js").NotificationDocument[];
    total: number;
    unreadCount: number;
}>;
export declare function markNotificationRead(id: string, userId: ObjectId): Promise<import("../interfaces/models.js").NotificationDocument>;
