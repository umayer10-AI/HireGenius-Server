...
export const listJobs = asyncHandler(async (req, res) => {
    const result = await jobService.list(req.query, req.user);
...
export const getMyJobs = asyncHandler(async (req, res) => {
    const result = await jobService.getMine(req.user, req.query);
    return sendSuccess(res, result.data, "Your jobs fetched", 200, result.meta);
});
export const getJobCategories = asyncHandler(async (_req, res) => {
